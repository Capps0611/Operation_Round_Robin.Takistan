...
// Takistan AI
	if (_faction==5) then {
	_InfPool=	["O_Soldier_AT_F_bwru_me","O_Soldier_Marks_F_bwru_me","O_Soldier_AR_F_bwru_me","O_Soldier_Gren_F_bwru_me","O_Soldier_F_bwru_me","O_Medic_F_bwru_me","O_Soldier_sniper_F_bwru_me","O_Soldier_TL_F_bwru_me"];	
	_ArmPool=	[];
	_MotPool=	[];
	_ACHPool=	[];
	_CHPool=	[];
